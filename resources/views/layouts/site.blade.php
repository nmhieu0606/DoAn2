            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            <li><a class="nav-link nav_item" href="{{route('home.index')}}">Trang chủ</a></li>
                    ...
                    <ul class="navbar-nav attr-nav align-items-center">
                        @if (!Auth::guard('khachhang')->user())
                        <li><a class="nav-link nav_item" href="{{route('home.getdangnhap')}}">Đăng nhập</a></li>
                        <li><a class="nav-link nav_item" href="{{route('home.getdangky')}}">Đăng Ký</a></li>
                        @endif
                        <li>
